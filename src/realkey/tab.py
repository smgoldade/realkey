...
GenerationResult = dict[str, str | float | int]
...
class Tab(ABC):
    ...
    @abstractmethod
    async def generate(self, bg_worker) -> GenerationResult:
        """Generates the object this tab was designed for

        Returns:
            GenerationResult: A return dictionary with keys and values according to the following specification:
